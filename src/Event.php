...
class Event extends BaseObject
{
    ...
    public static function hasHandlers($class, $name)
    {
        ...
        foreach (self::$_eventWildcards as $nameWildcard => $classHandlers) {
            if (!Helper::matchWildcard($nameWildcard, $name, ['escape' => false])) {
                continue;
            }
            foreach ($classHandlers as $classWildcard => $handlers) {
                ...
                foreach ($classes as $className) {
                    if (Helper::matchWildcard($classWildcard, $className, ['escape' => false])) {
                        return true;
                    }
                }
            }
    ...
    public static function trigger($class, $name, $event = null)
    {
        ...
        foreach (self::$_eventWildcards as $nameWildcard => $classHandlers) {
            if (!Helper::matchWildcard($nameWildcard, $name)) {
                continue;
            }
        ...
        foreach ($classes as $class) {
            ...
            foreach ($wildcardEventHandlers as $classWildcard => $handlers) {
                if (Helper::matchWildcard($classWildcard, $class, ['escape' => false])) {
